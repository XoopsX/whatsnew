<?php
// $Id: bulletin_215.inc.php,v 1.1 2011/12/30 21:45:48 ohwada Exp $
...
{
	return bulletin_new_base( "'.$mydirname.'" , $limit, $offset );
}
...
function bulletin_new_base($mydirname, $limit=0, $offset=0)
{
	global $xoopsDB;
